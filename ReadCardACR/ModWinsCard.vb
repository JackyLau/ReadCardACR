...
#Region "Prototypes"
    ...
    ''' <returns></returns> 
    Public Declare Function SCardEstablishContext Lib "Winscard.dll" (ByVal dwScope As Integer,
                                                                  ByVal pvReserved1 As Integer,
                                                                  ByVal pvReserved2 As Integer,
    ...
    ''' <returns></returns> 
    Public Declare Function SCardConnect Lib "Winscard.dll" Alias "SCardConnectA" (ByVal hContext As Integer,
                                                                               ByVal szReaderName As String,
                                                                               ByVal dwShareMode As Integer,
                                                                               ByVal dwPrefProtocol As Integer,
                                                                               ByRef hCard As Integer,
    ...
    Public Declare Function SCardDisconnect Lib "Winscard.dll" (ByVal hCard As Integer,
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns> 
    Public Declare Function SCardListReaderGroups Lib "Winscard.dll" (ByVal hContext As Integer,
                                                                  ByRef mzGroups As String,
    ...
    ''' <param name="Disposition">[in] Action to take on the card in the connected reader on close. </param> 
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns> 
    Public Declare Function SCardEndTransaction Lib "Winscard.dll" (ByVal hCard As Integer,
                                                               ByVal Disposition As Integer) As Integer


    Public Declare Function SCardState Lib "Winscard.dll" (ByVal hCard As Integer,
                                                       ByRef State As Integer,
                                                       ByRef Protocol As Integer,
                                                       ByRef ATR As Byte,
    ...
    Public Declare Function SCardStatus Lib "Winscard.dll" Alias "SCardStatusA" (ByVal hCard As Integer,
                                                                             ByVal szReaderName As String,
                                                                             ByRef pcchReaderLen As Integer,
                                                                             ByRef State As Integer,
                                                                             ByRef Protocol As Integer,
                                                                             ByRef ATR As Byte,
                                                                             ByRef ATRLen As Integer) As Integer
    ...
    ''' If the function fails, it returns an error code. For more information, see Smart Card Return Values.</returns> 
    Public Declare Function SCardTransmit Lib "Winscard.dll" (ByVal hCard As Integer,
                                                          ByRef pioSendRequest As SCARD_IO_REQUEST,
                                                          ByRef SendBuff As Byte,
                                                          ByVal SendBuffLen As Integer,
                                                          ByRef pioRecvRequest As SCARD_IO_REQUEST,
                                                          ByRef RecvBuff As Byte,
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns> 
    Public Declare Function SCardListReaders Lib "Winscard.dll" Alias "SCardListReadersA" (ByVal hContext As Integer,
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns>
    ''' <remarks></remarks>
    Public Declare Function SCardGetStatusChange Lib "Winscard.dll" Alias "SCardGetStatusChangeA" (ByVal hContext As Integer,
                                                                                               ByVal TimeOut As Integer,
                                                                                               ByRef ReaderState As SCARD_READERSTATE,
    ...
    ''' <returns>This function returns different values depending on whether it succeeds or fails.</returns> 
    Public Declare Function SCardControl Lib "Winscard.dll" (ByVal hCard As Integer,
                                                          ByVal dwControlCode As Integer,
                                                          ByRef pvInBuffer As Byte,
                                                          ByVal cbInBufferSize As Integer,
                                                          ByRef pvOutBuffer As Byte,
...
#Region "Miscellaneous"
    ...
    ''' <returns></returns> 
    Public Function GetScardErrMsg(ByVal errCode As Long) As String
        Select Case errCode
    ...
    Public Sub LoadListControl(ByVal ctrl As System.Windows.Forms.ComboBox, ByVal readerList As String)
        ctrl.Items.Clear()
